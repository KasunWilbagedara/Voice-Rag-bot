...
export const DocumentManager: React.FC<DocumentManagerProps> = ({ apiKey, onDocumentsChange }) => {
  ...
  const getDocIcon = (title: string) => {
    ...
    if (lower.endsWith('.docx') || lower.endsWith('.doc')) return <FileText className="w-4 h-4 text-amber-400" />;
    ...
    <div className="w-full glass-panel rounded-3xl p-5 md:p-6 flex flex-col gap-5 border border-white/10 shadow-2xl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-white/10 pb-4">
        ...
        <div className="flex items-center gap-2">
          <span
            className={`text-[10px] px-2.5 py-1 rounded-full font-bold tracking-wider uppercase border flex items-center gap-1.5 ${dbActive
      ...
      <div
        ...
        className={`border-2 border-dashed transition-all duration-200 rounded-2xl p-7 flex flex-col items-center justify-center gap-3 cursor-pointer group ${isDragging
